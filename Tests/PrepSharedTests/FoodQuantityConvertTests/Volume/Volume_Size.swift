...
extension FoodQuantityConvertTests {
    func testVolumeToSize() throws {
        for testCase in TestCases.Volume_Size {
...
extension TestCases {
    static let Volume_Size = [

        /// volume based sizes
        FoodQuantityTestCase(
            quantity: FoodQuantity(
                3, .gallonUSDry, /// 4404.88
                Food(
                    sizes: [
                        .init(2, "bottle", .init(3.5, .cupMetric)), /// 250 mL
                        .init(1.5, "box", .init(30, "bottle")),
                        .init(5, "carton", .init(15, "box")),
                    ]
                )
            ),
            equivalentSizes: [
                (nil, "bottle", 30.20489143),
                (nil, "box", 1.51024457),
                (nil, "carton", 0.50341486)
            ]
        ),
