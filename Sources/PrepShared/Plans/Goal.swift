...
public struct Goal: Identifiable, Hashable, Codable {
    ...
    public var calculatedBound: Bound
...
public extension Array where Element == Goal {
    ...
    var carbBound: Bound? { bound(for: .carb) }
    var fatBound: Bound? { bound(for: .fat) }
    var proteinBound: Bound? { bound(for: .protein) }

    func bound(for macro: Macro) -> Bound? {
