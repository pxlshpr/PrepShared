...
public struct NoticeAction {
    ...
    public let onTrigger: () -> ()
    
    public init(title: String, onTrigger: @escaping () -> Void) {
        self.title = title
...
public struct Notice {
    ...
    public static func legacy(_ date: Date? = nil) -> Notice {
        .init(
//            title: "Legacy Data",
...
public struct NoticeSection: View {
    ...
    public static func legacy(_ date: Date? = nil) -> Self {
