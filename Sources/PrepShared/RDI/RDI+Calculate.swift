...
public extension RDIValue {
    func calculateBound(
        ...
        case .quantityPerEnergy(let double, let energyUnit):
            ...
            return switch (bound.lower, bound.upper) {
...
//        let paramCombos = values.allParamCombos
//        for params in paramCombos {
//            guard bound(params: params, energyInKcal: 1000) != nil else {
//                return false
//            }
//        }
//        return true
//    }
    ...
    func calculateBound(
        ...
        guard let value = values.compatibleValue(for: params) else { return nil }
        return value.calculateBound(
            type: type,
